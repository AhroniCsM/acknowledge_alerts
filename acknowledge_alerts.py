...
def main():
    ...
    if len(sys.argv) > 1 and sys.argv[1] in ['-h', '--help', 'help']:
        print("Coralogix Alert Acknowledgment Script")
        print("=" * 80)
        print("\nUsage:")
        print("  python3 acknowledge_alerts.py <api-key> [region]")
        print("\nArguments:")
        print("  api-key  : Coralogix API key (required)")
        print("  region   : Coralogix region (optional, default: eu1)")
        print("             Options: us1, us2, eu1, eu2, ap1, ap2, ap3")
        print("\nExamples:")
        print("  python3 acknowledge_alerts.py 'cxup_xxx'")
        print("  python3 acknowledge_alerts.py 'cxup_xxx' 'us1'")
        print("\nEnvironment Variables (alternative):")
        print("  export CORALOGIX_API_KEY='cxup_xxx'")
        print("  export CORALOGIX_REGION='eu1'")
